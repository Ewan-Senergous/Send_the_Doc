...
<body>
    <div class="container">
        <div class="header">
            <h1>Diagnostic Pompe à Palettes5</h1>
            <p>Fiche technique digitalisée5</p>
        ...
        <div class="form-content">
            ...
            <div class="step" id="step6">
                ...
                <div class="report-send-section">
                    ...
                    <form method="post" action="" id="diagnosticReportForm">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    console.log('✅ Données collectées:', diagnosticData);
        ...
        function collectFormData() {
            return {
                ...
                photos: {
                    ...
                    total: document.getElementById('plaque_photos').files.length + 
                           document.getElementById('etat_photos').files.length + 
                           document.getElementById('mesures_photos').files.length + 
                           document.getElementById('diagnostic_photos').files.length + 
                           document.getElementById('final_photos').files.length
                },
            ...
            foreach ($photoFields as $fieldName) {
                if (isset($_FILES[$fieldName]) && !empty($_FILES[$fieldName]['name'][0])) {
                    ...
                    foreach ($_FILES[$fieldName]['name'] as $key => $name) {
                        ...
                        // Déplacer le fichier vers les pièces jointes
